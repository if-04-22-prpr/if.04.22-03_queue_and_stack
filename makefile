...
TEST    = test_queue_stack
PROGRAM = queue_stack

COMMON_HDRS      = config.h general.h list.h
LIBRARY_FILES    = shortcut allocator
ASSIGNMENT_HDRS  = 
ASSIGNMENT_FILES = advanced_singly_linked_list queue stack
TEST_FILES       = test_list test_queue test_stack
MAIN_DRIVER      = queue_stack_main_driver
TEST_DRIVER      = queue_stack_test_driver
